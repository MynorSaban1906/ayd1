...
export default function MisServiciosAgencia() {
    ...
    async function Agregar() {
        ...
        console.log(modeloState)
        console.log(placaState)
        console.log(precioState)
        console.log(fechaFinState)
        console.log(capacidadState)
        console.log(base64code)
        console.log(id_usuario)
        axios.post("http://34.125.201.105:4000/v1/fullTrip/CreateAutomovil", {
            Marca: marcaState,
            Placa: placaState,
            Modelo: modeloState,
            Precio: precioState,
                    ...
                    <Box sx={{ ...style, width: 400 }}>
                        ...
                        <p>
                            ...
                            <TextField
                                ...
                                name='TFNombre'
                                label="Ingrese Marca del Automovil:"
                                placeholder="Nissan"
                                InputProps={{
                                    startAdornment: (
                                ...
                                variant="standard"
                                onChange={event => setMarcaState(event.target.value)}
                            // ref={inputNombre}
                            />
                        </p>
                        ...
                        <p>
                            ...
                            <TextField
                                id="input-with-icon-textfield"
                                name='TFNombre'
                                label="Ingrese Modelo del Automovil:"
                                placeholder="Sentra"
                                InputProps={{
                                    startAdornment: (
                                        <InputAdornment position="start">
                                ...
                                variant="standard"
                                onChange={event => setModeloState(event.target.value)}
                            // ref={inputNombre}
                            />
                        </p>
                        ...
                        <p>
                            ...
                            <TextField
                                id="input-with-icon-textfield"
                                name='TFNombre'
                                label="Ingrese Placa del Automovil:"
                                placeholder="P0307CYJ"
                                InputProps={{
                                    startAdornment: (
                                        <InputAdornment position="start">
                                            {/* <AccountBoxIcon /> */}
                                ...
                                variant="standard"
                                onChange={event => setPlacaState(event.target.value)}
                            // ref={inputNombre}
                            />
                        </p>
                        ...
                        <p>
                            ...
                            <TextField
                                id="input-with-icon-textfield"
                                name='TFNombre'
                                label="Ingrese Precio de Renta del Automovil:"
                                placeholder="Q 0.00"
                                InputProps={{
                                    startAdornment: (
                                        <InputAdornment position="start">
